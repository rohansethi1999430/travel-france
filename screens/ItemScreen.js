    ...
    return (
      <SafeAreaView className="flex-1 bg-white relative">
        <ScrollView className="flex-1 px-4 py-6">
          ...
          <Text className = " font-semibold text-[26px] text-[#428288]">Reviews:</Text>
          <Text className="mt-4 tracking-wide text-[16px] font-semibold text-[#97A6AF]">
             <Text className="mt-4 tracking-wide text-[16px] font-bold text-[#6b757a]">
                John: 
            </Text> 
                Awesome place..must visit during summer
            </Text>
          ...
          <View className=" space-y-2 mt-4 bg-gray-100 rounded-2xl px-4 py-2">
            <Text className = " font-semibold text-[26px] text-[#428288]">Travel Agent Details:</Text>
            {data?.phone && (
